(function () {
	...
	var FIELDS = [{
		"name": "checkbox",
		"template": "<div class=\"checkbox\" ng-class=\"{mt: options.templateOptions.help}\"><input ng-model=\"model[options.key]\" id=\"{{::id}}\" name=\"{{::id}}\" type=\"checkbox\" class=\"checkbox__input\" ng-disabled=\"options.templateOptions.disabled\" aria-labelledby=\"{{::id}}\"><label class=\"checkbox__label\">{{::options.templateOptions.label}}</label><span class=\"checkbox__help\">{{::options.templateOptions.help}}</span></div>"
	}, {
		"name": "date-picker",
		...
		"name": "switch",
		"template": "<div class=\"switch\" ng-class=\"{mt: options.templateOptions.help}\"><input ng-model=\"model[options.key]\" id=\"{{::id}}\" name=\"{{::id}}\" type=\"checkbox\" class=\"switch__input\" ng-disabled=\"options.templateOptions.disabled\" aria-labelledby=\"{{::id}}\"><label class=\"switch__label\">{{::options.templateOptions.label}}</label><span class=\"switch__help\">{{::options.templateOptions.help}}</span></div>"
	}, {
		"name": "text",
