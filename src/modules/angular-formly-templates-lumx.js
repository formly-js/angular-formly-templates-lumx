...
(function () {
	...
	var FIELDS = [
		{
			name: 'date-picker',
			template: "<div><lx-date-picker formly-dynamic-name=\"::id\" model=\"model[options.key]\" label=\"{{::options.templateOptions.label}} {{::options.templateOptions.required ? \'*\' : \'\'}}\" ng-disabled=\"::options.templateOptions.disabled\" ng-required=\"::options.templateOptions.required\" aria-describedby=\"{{::id}}_datePicker\"></lx-date-picker></div>"
		}, {
			name: 'select',
			template: "<div><br><h3><label for=\"{{::id}}\">{{::options.templateOptions.label || \'Select\'}} {{::options.templateOptions.required ? \'*\' : \'\'}}</label></h3><lx-select id=\"{{::id}}\" ng-model=\"model[options.key]\" formly-dynamic-name=\"::id\" aria-describedby=\"{{::id}}_select\" choices=\"options.templateOptions.options\" placeholder=\"{{::options.templateOptions.placeholder}}\" min-length=\"::options.templateOptions.minLength\" ng-disabled=\"::options.templateOptions.disabled\" allow-clear=\"::options.templateOptions.allowClear\"><lx-select-selected>{{$selected[options.templateOptions.selected]}} {{::options.templateOptions.selected2 ? \' - \' + $selected[options.templateOptions.selected2] : \'\'}}</lx-select-selected><lx-select-choices>{{$choice[options.templateOptions.choice]}} {{::options.templateOptions.choice2 ? \' - \' + $choice[options.templateOptions.choice2] : \'\'}}</lx-select-choices></lx-select></div>"
		}, {
	...
	var WRAPPERS = [
		{
			...
			name: 'flex-box',
			template: "<div ng-class=\"::options.templateOptions.flexClass\" flex-item=\"{{::options.templateOptions.flexItem}}\" flex-order=\"{{::options.templateOptions.flexOrder}}\"><formly-transclude></formly-transclude></div>"
		}, {
			name: 'above',
			...
			name: 'div',
			template: "<div ng-class=\"::options.templateOptions.divClass\" ng-style=\"::options.templateOptions.divStyle\"><formly-transclude></formly-transclude></div>"
		}
	];
