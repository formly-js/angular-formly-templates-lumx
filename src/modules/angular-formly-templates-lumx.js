angular.module('formlyLumx', ['formly'], function configFormlyLumx(formlyConfigProvider) {
	'use strict';
	var PREFIX = 'lx';
	var FIELDS = [{
		"name": "checkbox",
		...
		"name": "flex",
		"template": "<div id=\"{{::id}}\" ng-class=\"::options.templateOptions.flex.className\" style=\"::options.templateOptions.flexContainer.style\" flex-container=\"{{::options.templateOptions.flex.container}}\" flex-align=\"{{::options.templateOptions.flex.align}}\" flex-gutter=\"{{::options.templateOptions.flex.gutter}}\"><formly-form fields=\"options.templateOptions.fields\" model=\"::$parent.model\"></formly-form></div>"
	}, {
		"name": "radio",
